# pmd-text-case  
It's a case to add a language module in PMD, what language I tried to add is type of text, just means I want to scan/analysis text strings by PMD. Because PMD's ability of reporting violations is useful and it's powerfully good for the integration with other CI tools such as Jenkins, SonarQube...  
