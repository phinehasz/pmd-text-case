...
public class TextParserOptions extends ParserOptions {
    ...
    public TextParserOptions(Rule rule) {
	...
	final TextParserOptions that = (TextParserOptions) obj;
