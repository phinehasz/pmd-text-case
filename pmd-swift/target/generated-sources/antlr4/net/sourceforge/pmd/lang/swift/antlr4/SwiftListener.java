...
public interface SwiftListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SwiftParser#forStatement}.
	 * @param ctx the parse tree
	 */
	void enterForStatement(SwiftParser.ForStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link SwiftParser#forStatement}.
	 * @param ctx the parse tree
	 */
	void exitForStatement(SwiftParser.ForStatementContext ctx);
	/**
	 * Enter a parse tree produced by {@link SwiftParser#forInit}.
	 * @param ctx the parse tree
	 */
	void enterForInit(SwiftParser.ForInitContext ctx);
	/**
	 * Exit a parse tree produced by {@link SwiftParser#forInit}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link SwiftParser#parameterClauses}.
	 * @param ctx the parse tree
	 */
	void enterParameterClauses(SwiftParser.ParameterClausesContext ctx);
	/**
	 * Exit a parse tree produced by {@link SwiftParser#parameterClauses}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link SwiftParser#expressionList}.
	 * @param ctx the parse tree
	 */
	void enterExpressionList(SwiftParser.ExpressionListContext ctx);
	/**
	 * Exit a parse tree produced by {@link SwiftParser#expressionList}.
	 * @param ctx the parse tree
	 */
